...
with(umap_cancertype %>% 
     ...
     scatter3D(plot_y, -plot_z, plot_x, 
               ...
               colvar = NULL))
legend("top", inset = c(0), legend=rev(names(I_colors)), col=rev(I_colors), pch = 20, bty = "n", horiz = T, cex = 1.2)
...
with(umap_cancertype %>% 
     ...
     scatter3D(plot_y, -plot_z, plot_x, 
               ...
               xlab = "", ylab = "UMAP 3", zlab = "UMAP 1",
               colvar = NULL))
legend("top", inset = c(0), legend=names(J_colors), col=J_colors, pch = 20, bty = "n", horiz = T, cex = 1.2)
title(xlab="UMAP 2", line=0)
### K - BRCA Somatic Mutations
...
with(brca %>% filter(mut_type != "NA"),
     scatter3D(plot_y, -plot_z, plot_x, 
               ...
               xlab = "", ylab = "UMAP 3", zlab = "UMAP 1",
               colvar = NULL))
legend("top", inset = c(0), legend=names(K_colors), col=K_colors, pch = 20, bty = "n", horiz = T, cex = 1.2)
title(xlab="UMAP 2", line=0)
### L - Stage
...
with(umap_cancertype %>% filter(ajcc_pathologic_tumor_stage != "Not Available"),
     scatter3D(plot_y, -plot_z, plot_x, 
               ...
               xlab = "", ylab = "UMAP 3", zlab = "UMAP 1",
               colvar = NULL))
legend("top", inset = c(0), legend=names(L_colors), col=L_colors, pch = 20, bty = "n", horiz = T, cex = 1.2)
title(xlab="UMAP 2", line=0)
### M - Metastasis
