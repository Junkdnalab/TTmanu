```{r figure-4-data-generation_function}
...
oncoprint_style <- function(filtered_class, n_path, enrich_cutoff = 0.30) {
  ...
  plot <- plot_grid(plotlist = plotlist, align = "h", ncol = 11, axis = "tb", rel_widths = c(rep(0.1, length(l_anno_ggplot)), 15))
plot_legend <- plot_grid(plotlist = path_legend, ncol = 5)

return(plot_grid(plot, plot_legend, ncol = 1, rel_heights = c(10, 1.5)))
}

# class2 <- oncoprint_style(filtered_class = 2, n_path = 10)
# class2
# class3 <- oncoprint_style(filtered_class = 3, n_path = 10)
# class3
# class4 <- oncoprint_style(filtered_class = 4, n_path = 10)
# class4
# class5 <- oncoprint_style(filtered_class = 5, n_path = 10)
# class5
# class6 <- oncoprint_style(filtered_class = 6, n_path = 10)
# class6
# class7 <- oncoprint_style(filtered_class = 7, n_path = 10)
# class7
# class9 <- oncoprint_style(filtered_class = 9, n_path = 10)
# class9
# class10 <- oncoprint_style(filtered_class = 10, n_path = 10)
# class10
# class11 <- oncoprint_style(filtered_class = 11, n_path = 10)
# class11
# class12 <- oncoprint_style(filtered_class = 12, n_path = 10)
# class12
