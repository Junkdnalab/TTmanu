...
cluster_umap <- uwot::umap(mca_res$ind$coord,
  min_dist = 1e-6,
  n_components = 3,
  n_neighbors = round(sqrt(nrow(mca_res$ind$coord))),
  n_epochs = 1000,
...
umap_3d_coors <- gdc_umap_coors %>%
  ...
  mutate(
    ...
    row.names = rownames(gdc_umap_coors)
  )
...
fig1A + empty_plot + fig1C + empty_plot + fig1E + fig1F + fig1G + fig1H + fig1I + fig1J + fig1K + fig1L + plot_layout(design = layout) + plot_annotation(tag_levels = 'A')
