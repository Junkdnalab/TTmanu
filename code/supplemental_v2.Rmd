...
**S1 Fig. Distribution of cancer type on UMAP clusters.** Each panel shows the identity of 
individual tumors by one of 23 cancer types projected onto the cluster UMAP identified 
in **Fig 1B of the main text**. The colors indicate the tumor's cluster identity.
...
**S2 Fig. Histological subtypes.** Each panel shows the histological subtypes of one of the 23 
cancers projected onto the tumors of the UMAP from **Fig 1B of the main text**. The colors indicate the tumor's histological subtype identity.
...
**S3 Fig. Distribution of mismatch repair genes on UMAP clusters.** Each panel shows one of 15 
genes involved in genome stability projected on the UMAP from **Fig 1B of the main text**. The colors indicate the tumor's cluster identity.
...
**S4 Fig. Distribution of oncogenes/tumor suppressors on UMAP clusters.** Each panel shows shows one of the twelve oncogenes/tumor suppressors projected onto the tumors of the UMAP from **Fig 1B of the main text**. The colors indicate the tumor's cluster identity.
...
for(n in model) {
  ## Load correct model
  if(n == "knn") {
    load("./survival/survmodel_effcl_knn_062821.stansave")
  } else if(n == "icluster") {
    load("./survival/survmodel_effcl_icluster_062821.stansave")
  } else if (n == "coca") {
    load("./survival/survmodel_effcl_coca_062821.stansave")
  } else if (n == "tis") {
    load("./survival/survmodel_effcl_tis_062821.stansave")
  } else {
