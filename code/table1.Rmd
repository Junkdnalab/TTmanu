...
gc()
```
<p style="FONT-SIZE:10px; COLOR:#000000; LINE-HEIGHT:12px;">**Table 1: Most frequently mutated gene in class-specific enriched pathways (effect size >= 0.30) for specific cancer**</p>
```{r table-1}
...
cluster_spec_enrich_table %>% .[, c("Pathway", "Class", n_tumor)] %>% knitr::kable(format = "html", row.names = FALSE) %>%
