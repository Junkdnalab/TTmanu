...
mutations in cancer driver genes are commonplace in somatic tissues and
...
by the aggregate of mutations in the nearest network neighbors
...
highlighting some potentially fundamental disease phenotypes at the pathway
level that cross cancers with different origins at the cellular and tissue
level.
...
evaluate all cancers and show that, surprisingly, tumors that exhibit
tissue-specific gene mutation patterns nonetheless fall into common categories
of pathway disruption having unique prognoses in each cancer type.