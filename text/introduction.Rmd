...
moderate effect genes that occur at such low frequency given tissue diversity
and low sample numbers that they are impossible to detect using positive
...
cell-type-specific information from the mutation data and generalizes gene-level
information to cell-biological pathway phenotypes. We use this heuristic to
