...
large numbers of tumors and collected data from multiple assays to analyze together, with the goal of
...
genes mutated at a greater rate than expected due to chance. Dees et al. [@deesMuSiC2012]
developed a pipeline to separate driver mutations from passenger mutations. 
Tamborero et al. [@tamboreroOncodriveCLUST2013] expanded on this idea to identify 
tumor mutation biases towards specific regions of a protein sequence. Lawrence et 
al. [@lawrenceDiscoverySaturationAnalysis2014] focused on identifying cancer driver 
genes with intermediate mutation frequencies using tumor-normal pairs. It has been
...
has long been a goal of the field as characterized in essays by Hanahan and Weinberg
...
disruptions of normal pathway activity. Pathway-centric analysis of tumors
provides additional benefits over gene-centric analysis: (1) It is significantly 
less noisy because it aggregates molecular events across multiple genes in the 
same pathway and (2) the identification of a potential casual mechanism is easier 
to interpret as genetic aberrations are linked to molecular pathways. In a perspective, 
Creixell et al. [@Creixell-pathwaynetworkanalysis] described approaches of pathway 
and network analysis applicable to next-generation sequencing data. The most common 
approach being fixed-gene enrichment analysis to identify over-represented pathways. 
Sanchez-Vega et al. [@PCAWG-PATH] carried out an exhaustive
analysis of pathway enrichment using whole genome data. Focusing on ten frequently 
altered canonical signaling pathways in cancer, they explored the mutation frequencies 
of coding regions of genes in these pathways for each cancer type. Network approaches
