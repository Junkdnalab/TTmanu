...
common themes of all cancer independent of tissue of origin. The first of these
(the “Pan-Cancer-12” analysis) identified 11 subtypes from 12 cancer types,
...
could be further related or subdivided into organ specific groups, including
...
cancer subtypes onto the UMAP. j) projection of tumor stage onto the UMAP,
regardless of cancer type. k) Projection of metastatic status onto the UMAP.
...
cancer types had representative tumors in every class (for example **figure 1g**
