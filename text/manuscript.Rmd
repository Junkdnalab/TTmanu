...
3D UMAP is shown in **figure 2C** as a 2D projection, rotated to enhance the
...
cancer types had representative tumors in every class (for example **figure 3A**
...
observed an even distribution across classes (**figure 3E**). This
