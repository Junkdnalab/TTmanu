...
pathway disruption clusters (**figure 3D**), suggesting that stage is not a
contributing factor to cluster identity.
...
(**figure 5A**). Using this approach, we identified 25 pathways highly enriched
(enrichment score ≥ 0.3, 95% confidence; see methods) in cluster 2, 9 pathways
enriched in cluster 3, 24 pathways in cluster 4, 10 pathways in cluster 5, 10
pathways in cluster 6, 24 pathways in cluster 7, 24 pathways in cluster 8, 10
pathways in cluster 9, and 0 pathways for clusters 1 and 10. Clusters 7, 8, and
...
for one cluster are depleted from others ( _e.g. TP53_ is enriched in cluster 6,
