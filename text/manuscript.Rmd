...
identity throughout this manuscript. 1=yellow, 2=lilac, 3=orange, 4=light blue,
5=crimson, 6=beige, 7=grey, 8=dark green, 9=pink, 10=dark blue.
...
also interactive media from **supplementary file 1 (html)**), suggesting that,
...
S1**). But even PAAD comprises tumors from the nine remaining classes, meaning
...
B) Projection of cancer type identity onto UMAP. Abbrevs: BRCA = Breast cancer,
COAD = Colorectal adenocarcinoma, HNSC = Head and neck squamous cell, PAAD =
Pancreatic adenocarcinoma. C) Projection of breast cancer subtypes onto the
UMAP. D) Projection of BRCA1/2 somatic mutation onto the UMAP. E) Projection of
