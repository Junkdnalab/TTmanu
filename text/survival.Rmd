...
cohorts. A) A group consisting of randomly selected 30 year old women (light
blue) vs. an equal sized group of 30 year old women with cancer, k = 2 (light
orange). To illustrate how the mix of ages alters the survival curve, we compare
a randomly selected group of people with ages uniformly distributed from 30 to
70 (dark blue) and a randomly selected group with uniformly distributed ages and
cancer k = 2 (dark orange). B,C,D,E) We compare a randomly selected group with
