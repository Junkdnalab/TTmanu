If our clusters represent biological states
...
of survival using
public longevity data from the CDC.
...
To illustrate the model, in **Figure 7A** we simulate survival time curves
...
simplicity. F) Effects are compared between cancer type by
...
the general population. In **Figure 7B-E** we see three particularly deadly
