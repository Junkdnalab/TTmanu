...
To understand the model, see **Figure 7A** where we show simulated survival time
...
ktis multiplier (**Figure 7F**) multiplied by the class specific modifier
...
the population. This undoubtedly is due to the fact that relatively young
...
indestinguishable from the prior, reflecting that either there were too few
...
surgical treatments typical used for each tissue.
