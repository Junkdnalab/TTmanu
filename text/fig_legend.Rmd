...
projected down to 3 dimensions for the purpose of density based clustering. 
Each dot represents a tumor d) HDBSCAN was used to perform hierarchical density 
based clustering tuned to minimize the fraction of unassigned tumors. e) HDBSCAN 
clustered tumors were visualized on the UMAP projection; tumors are colored by 
cluster membership (see legend). This results in some tumors remaining unclassified
(grey points). f) kNN was used to assign membership to the remaining tumors.
