...
probability of membership of ≥ 5% in at least one cluster. Thus, we created a
score metric as the fraction of classified tumors with max probability < 5% in
one cluster and chose a cluster size of 92 to minimize the score function
...
sample based on their cluster labels. We set _k_ to be the square root of
