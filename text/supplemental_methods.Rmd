...
shown in **figure SM1C**, rotated to enhance the visibility of the major features.
...
(**figure SM1D**). HDBSCAN with these settings resulted in ten distinct
...
membership to the remaining tumors (**figure SM1F**).
...
**supplementary figure SM2** gives a comparison on log-scale between
