...
tissue-specific cluster effects. Contrast ovarian _vs._ breast cancer, which are
both hormonally driven cancers, for example. Ovarian cancer has but one main
treatment axis, platinum, whereas breast cancer patients have a variety of
treatment regimens based on molecular subtype and other factors. Unfortunately,
given the diversity of drug classes and treatments, we lack sufficient power to
explore these variables in the TCGA data. It is our hope that future studies
will help to distinguish between treatment-specific effects on survival given
different pathway disruption clusters.
