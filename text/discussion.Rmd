...
associations using Bayesian networks have yielded important new insights into
this problem and new genes [@hornNetSigNetworkbasedDiscovery2018] that would not
have been possible with traditional analysis, supporting the case that
pathway-centric approaches have the potential to increase statistical power.
...
viewed at the level of the pathway knowledge-base. Top cancer driver genes (e.g.
PIK3C and TP53) are found in most of the clusters, in spite of the fact that
