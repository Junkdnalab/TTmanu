...
frame-shift, stop-gain, untranslated region and splice site mutations in genes
...
disruptions in basic pathways as represented by our classes (**figures 1 & 2**). 
...
(**figure 2D**) or metastasis (**figure 2E**); and each class instead was
...
were exclusive to a single tumor class. Only cancer types with the fewest
...
treatment regimens have greater efficacy for patients of a given cancer or
histological subtype [@breast-subtypes2]. Nonetheless, the basis for some tumors
being treatment-refractory in spite of receiving the standard of clinical care
for diagnostic markers remains elusive. Doubtless some of this is due to bad
luck, as tumors can metastasize and remain dormant years before they are
...
are heavily skewed to cluster 1 membership (**Supplementary figure S1**).
Likewise, Class 10 represents a group of hyper-mutated tumors that harbor so
many mutations that virtually no pathway is unaffected. It seems likely that a
significant fraction of the “mutant” samples for each pathway are burdened with
excess passenger mutations. This could be addressed with application of
ever-increasingly sophisticated filtering likely passenger mutations [ _e.g._
...
expected survival (**figure 7**). Contrary to what one might expect at the
...
very between cancers, it makes sense that we observe tissue-specific class
...
of class-specific defects via random mutation and natural selection, thus
producing the classes we observed. In support of this, the pan-cancer analysis
...
our analysis, metastasis has class-specific requirements. Since the number of
...
the class-specific metastatic pathway enrichment we observe (in **table 1**)
could be a result of the pathways directly promoting metastatic phenotypes in
these classes, or because they acquire a stronger or more complete oncogenic
...
distinguishing these classes from the others in the order or nature of hallmark
