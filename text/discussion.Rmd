...
of proteins ( _e.g._ transcription factors) which are potentially problematic
...
background. Previous attempts to capture these associations better using
...
like ours have the potential to increase statistical power.
